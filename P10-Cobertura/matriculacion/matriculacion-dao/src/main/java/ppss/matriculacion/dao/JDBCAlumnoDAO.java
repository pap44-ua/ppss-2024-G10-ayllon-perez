 ...
 *
 */
public class JDBCAlumnoDAO implements ppss.matriculacion.dao.IAlumnoDAO {

	public void addAlumno(AlumnoTO a) throws ppss.matriculacion.dao.DAOException {
		Connection con = null;
		...
		try {
			...
			throw new ppss.matriculacion.dao.DAOException("Error al conectar con BD", e);
		} finally {
			if(con!=null) {
				try {
					con.close();
	...
	public void delAlumno(String nif) throws ppss.matriculacion.dao.DAOException {
		Connection con = null;
		PreparedStatement ps = null;
		try {
			con = FuenteDatosJDBC.getInstance().getConnection();
			...
			if(rowCount==0) {
				throw new ppss.matriculacion.dao.DAOException("No se ha borrado ningun alumno");
			}
	...
	public List<AlumnoTO> getAlumnos() throws ppss.matriculacion.dao.DAOException {
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
	...
	public AlumnoTO getAlumno(String nif) throws ppss.matriculacion.dao.DAOException {
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
